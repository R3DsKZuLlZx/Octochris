...
using System;
namespace GitHub.EnterpriseCloud.EnterpriseInstallation.Item.ServerStatistics
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.EnterpriseCloud.EnterpriseInstallation.Item.ServerStatistics.ServerStatisticsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A List&lt;global::GitHub.EnterpriseCloud.Models.ServerStatistics&gt;</returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<List<global::GitHub.EnterpriseCloud.Models.ServerStatistics>?> GetAsync(Action<RequestConfiguration<global::GitHub.EnterpriseCloud.EnterpriseInstallation.Item.ServerStatistics.ServerStatisticsRequestBuilder.ServerStatisticsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::GitHub.EnterpriseCloud.Models.ServerStatistics>> GetAsync(Action<RequestConfiguration<global::GitHub.EnterpriseCloud.EnterpriseInstallation.Item.ServerStatistics.ServerStatisticsRequestBuilder.ServerStatisticsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::GitHub.EnterpriseCloud.Models.ServerStatistics>(requestInfo, global::GitHub.EnterpriseCloud.Models.ServerStatistics.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.EnterpriseCloud.EnterpriseInstallation.Item.ServerStatistics.ServerStatisticsRequestBuilder.ServerStatisticsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.EnterpriseCloud.EnterpriseInstallation.Item.ServerStatistics.ServerStatisticsRequestBuilder.ServerStatisticsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.EnterpriseCloud.EnterpriseInstallation.Item.ServerStatistics.ServerStatisticsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.EnterpriseCloud.EnterpriseInstallation.Item.ServerStatistics.ServerStatisticsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.EnterpriseCloud.EnterpriseInstallation.Item.ServerStatistics.ServerStatisticsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Returns aggregate usage metrics for your GitHub Enterprise Server 3.5+ instance for a specified time period up to 365 days.To use this endpoint, your GitHub Enterprise Server instance must be connected to GitHub Enterprise Cloud using GitHub Connect. You must enable Server Statistics, and for the API request provide your enterprise account name or organization name connected to the GitHub Enterprise Server. For more information, see &quot;[Enabling Server Statistics for your enterprise](/admin/configuration/configuring-github-connect/enabling-server-statistics-for-your-enterprise)&quot; in the GitHub Enterprise Server documentation.OAuth app tokens and personal access tokens (classic) need:  - the `read:enterprise` scope if you connected your GitHub Enterprise Server to an enterprise account and enabled Server Statistics  - the `read:org` scope if you connected your GitHub Enterprise Server to an organization account and enabled Server Statistics
        /// </summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class ServerStatisticsRequestBuilderGetRequestConfiguration : RequestConfiguration<global::GitHub.EnterpriseCloud.EnterpriseInstallation.Item.ServerStatistics.ServerStatisticsRequestBuilder.ServerStatisticsRequestBuilderGetQueryParameters>
        {
        }
    }
}
