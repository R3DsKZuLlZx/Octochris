...
#nullable enable
        public List<global::GitHub.EnterpriseCloud.Models.AdvancedSecurityActiveCommittersRepository>? Repositories { get; set; }
#nullable restore
#else
        public List<global::GitHub.EnterpriseCloud.Models.AdvancedSecurityActiveCommittersRepository> Repositories { get; set; }
#endif
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.EnterpriseCloud.Models.AdvancedSecurityActiveCommitters"/> and sets the default values.
        /// </summary>
        ...
        public static global::GitHub.EnterpriseCloud.Models.AdvancedSecurityActiveCommitters CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHub.EnterpriseCloud.Models.AdvancedSecurityActiveCommitters();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "repositories", n => { Repositories = n.GetCollectionOfObjectValues<global::GitHub.EnterpriseCloud.Models.AdvancedSecurityActiveCommittersRepository>(global::GitHub.EnterpriseCloud.Models.AdvancedSecurityActiveCommittersRepository.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::GitHub.EnterpriseCloud.Models.AdvancedSecurityActiveCommittersRepository>("repositories", Repositories);
