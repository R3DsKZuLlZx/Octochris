...
namespace GitHub.EnterpriseCloud.Models
{
    ...
    public partial class UpdateCostCenter_ai_credit_pool_state : IAdditionalDataHolder, IParsable
    {
        ...
        /// </summary>
        public UpdateCostCenter_ai_credit_pool_state()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.EnterpriseCloud.Models.UpdateCostCenter_ai_credit_pool_state"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::GitHub.EnterpriseCloud.Models.UpdateCostCenter_ai_credit_pool_state CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHub.EnterpriseCloud.Models.UpdateCostCenter_ai_credit_pool_state();
        }
        /// <summary>
