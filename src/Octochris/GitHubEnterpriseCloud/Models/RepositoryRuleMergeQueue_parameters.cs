...
namespace GitHub.EnterpriseCloud.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public global::GitHub.EnterpriseCloud.Models.RepositoryRuleMergeQueue_parameters_grouping_strategy? GroupingStrategy { get; set; }
        ...
        public global::GitHub.EnterpriseCloud.Models.RepositoryRuleMergeQueue_parameters_merge_method? MergeMethod { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.EnterpriseCloud.Models.RepositoryRuleMergeQueue_parameters"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.EnterpriseCloud.Models.RepositoryRuleMergeQueue_parameters"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::GitHub.EnterpriseCloud.Models.RepositoryRuleMergeQueue_parameters CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHub.EnterpriseCloud.Models.RepositoryRuleMergeQueue_parameters();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "grouping_strategy", n => { GroupingStrategy = n.GetEnumValue<global::GitHub.EnterpriseCloud.Models.RepositoryRuleMergeQueue_parameters_grouping_strategy>(); } },
                { "max_entries_to_build", n => { MaxEntriesToBuild = n.GetIntValue(); } },
                { "max_entries_to_merge", n => { MaxEntriesToMerge = n.GetIntValue(); } },
                { "merge_method", n => { MergeMethod = n.GetEnumValue<global::GitHub.EnterpriseCloud.Models.RepositoryRuleMergeQueue_parameters_merge_method>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::GitHub.EnterpriseCloud.Models.RepositoryRuleMergeQueue_parameters_grouping_strategy>("grouping_strategy", GroupingStrategy);
            writer.WriteIntValue("max_entries_to_build", MaxEntriesToBuild);
            writer.WriteIntValue("max_entries_to_merge", MaxEntriesToMerge);
            writer.WriteEnumValue<global::GitHub.EnterpriseCloud.Models.RepositoryRuleMergeQueue_parameters_merge_method>("merge_method", MergeMethod);
