...
#nullable enable
        public global::GitHub.EnterpriseCloud.Models.NullableSimpleUser? Creator { get; set; }
#nullable restore
#else
        public global::GitHub.EnterpriseCloud.Models.NullableSimpleUser Creator { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::GitHub.EnterpriseCloud.Models.Deployment.Deployment_payload? Payload { get; set; }
#nullable restore
#else
        public global::GitHub.EnterpriseCloud.Models.Deployment.Deployment_payload Payload { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.EnterpriseCloud.Models.Deployment"/> and sets the default values.
        /// </summary>
        public Deployment()
        {
        ...
        public static global::GitHub.EnterpriseCloud.Models.Deployment CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHub.EnterpriseCloud.Models.Deployment();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "creator", n => { Creator = n.GetObjectValue<global::GitHub.EnterpriseCloud.Models.NullableSimpleUser>(global::GitHub.EnterpriseCloud.Models.NullableSimpleUser.CreateFromDiscriminatorValue); } },
                { "description", n => { Description = n.GetStringValue(); } },
                { "environment", n => { Environment = n.GetStringValue(); } },
                { "id", n => { Id = n.GetLongValue(); } },
                { "node_id", n => { NodeId = n.GetStringValue(); } },
                { "original_environment", n => { OriginalEnvironment = n.GetStringValue(); } },
                { "payload", n => { Payload = n.GetObjectValue<global::GitHub.EnterpriseCloud.Models.Deployment.Deployment_payload>(global::GitHub.EnterpriseCloud.Models.Deployment.Deployment_payload.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::GitHub.EnterpriseCloud.Models.NullableSimpleUser>("creator", Creator);
            ...
            writer.WriteObjectValue<global::GitHub.EnterpriseCloud.Models.Deployment.Deployment_payload>("payload", Payload);
...
#nullable restore
            ...
            /// Creates a new instance of the appropriate class based on discriminator value
            /// </summary>
            /// <returns>A <see cref="global::GitHub.EnterpriseCloud.Models.Deployment.Deployment_payload"/></returns>
            /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
            public static global::GitHub.EnterpriseCloud.Models.Deployment.Deployment_payload CreateFromDiscriminatorValue(IParseNode parseNode)
            {
                if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
                var mappingValue = parseNode.GetChildNode("")?.GetStringValue();
                var result = new global::GitHub.EnterpriseCloud.Models.Deployment.Deployment_payload();
