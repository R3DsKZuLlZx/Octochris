...
namespace GitHub.EnterpriseCloud.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        public global::GitHub.EnterpriseCloud.Models.ServerStatisticsPackages_ecosystems_enabled? Enabled { get; set; }
        ...
        public global::GitHub.EnterpriseCloud.Models.ServerStatisticsPackages_ecosystems_name? Name { get; set; }
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.EnterpriseCloud.Models.ServerStatisticsPackages_ecosystems"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.EnterpriseCloud.Models.ServerStatisticsPackages_ecosystems"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::GitHub.EnterpriseCloud.Models.ServerStatisticsPackages_ecosystems CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHub.EnterpriseCloud.Models.ServerStatisticsPackages_ecosystems();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "enabled", n => { Enabled = n.GetEnumValue<global::GitHub.EnterpriseCloud.Models.ServerStatisticsPackages_ecosystems_enabled>(); } },
                { "internal_packages_count", n => { InternalPackagesCount = n.GetIntValue(); } },
                { "name", n => { Name = n.GetEnumValue<global::GitHub.EnterpriseCloud.Models.ServerStatisticsPackages_ecosystems_name>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::GitHub.EnterpriseCloud.Models.ServerStatisticsPackages_ecosystems_enabled>("enabled", Enabled);
            writer.WriteIntValue("internal_packages_count", InternalPackagesCount);
            writer.WriteEnumValue<global::GitHub.EnterpriseCloud.Models.ServerStatisticsPackages_ecosystems_name>("name", Name);
