...
#nullable enable
        public List<global::GitHub.EnterpriseCloud.Models.GpgKey_emails>? Emails { get; set; }
#nullable restore
#else
        public List<global::GitHub.EnterpriseCloud.Models.GpgKey_emails> Emails { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::GitHub.EnterpriseCloud.Models.GpgKey_subkeys>? Subkeys { get; set; }
#nullable restore
#else
        public List<global::GitHub.EnterpriseCloud.Models.GpgKey_subkeys> Subkeys { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.EnterpriseCloud.Models.GpgKey"/> and sets the default values.
        /// </summary>
        public GpgKey()
        {
        ...
        public static global::GitHub.EnterpriseCloud.Models.GpgKey CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHub.EnterpriseCloud.Models.GpgKey();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "emails", n => { Emails = n.GetCollectionOfObjectValues<global::GitHub.EnterpriseCloud.Models.GpgKey_emails>(global::GitHub.EnterpriseCloud.Models.GpgKey_emails.CreateFromDiscriminatorValue)?.AsList(); } },
                ...
                { "subkeys", n => { Subkeys = n.GetCollectionOfObjectValues<global::GitHub.EnterpriseCloud.Models.GpgKey_subkeys>(global::GitHub.EnterpriseCloud.Models.GpgKey_subkeys.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::GitHub.EnterpriseCloud.Models.GpgKey_emails>("emails", Emails);
            ...
            writer.WriteCollectionOfObjectValues<global::GitHub.EnterpriseCloud.Models.GpgKey_subkeys>("subkeys", Subkeys);
