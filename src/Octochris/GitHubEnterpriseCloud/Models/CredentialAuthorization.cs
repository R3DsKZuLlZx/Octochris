...
namespace GitHub.EnterpriseCloud.Models
{
    ...
    public partial class CredentialAuthorization : IAdditionalDataHolder, IParsable
    {
        ...
        /// <summary>The ID of the underlying token or key that was authorized by the user. This will remain unchanged across authorizations of the token or key.</summary>
...
#nullable restore
        ...
        public global::GitHub.EnterpriseCloud.Models.CredentialAuthorization_credential_type? CredentialType { get; set; }
        /// <summary>Unique string to distinguish the credential. Only included in responses with a credential_type of SSH key.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public List<string> Scopes { get; set; }
#endif
        /// <summary>Last eight characters of the credential. Only included in responses with a credential_type of personal access token, OAuth app token, or GitHub app token.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.EnterpriseCloud.Models.CredentialAuthorization"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.EnterpriseCloud.Models.CredentialAuthorization"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::GitHub.EnterpriseCloud.Models.CredentialAuthorization CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHub.EnterpriseCloud.Models.CredentialAuthorization();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "credential_type", n => { CredentialType = n.GetEnumValue<global::GitHub.EnterpriseCloud.Models.CredentialAuthorization_credential_type>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::GitHub.EnterpriseCloud.Models.CredentialAuthorization_credential_type>("credential_type", CredentialType);
