...
#nullable restore
        ...
        public global::GitHub.EnterpriseCloud.Models.RuleSuite_evaluation_result? EvaluationResult { get; set; }
...
#nullable restore
        ...
        public global::GitHub.EnterpriseCloud.Models.RuleSuite_result? Result { get; set; }
        /// <summary>Details on the evaluated rules.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::GitHub.EnterpriseCloud.Models.RuleSuite_rule_evaluations>? RuleEvaluations { get; set; }
#nullable restore
#else
        public List<global::GitHub.EnterpriseCloud.Models.RuleSuite_rule_evaluations> RuleEvaluations { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.EnterpriseCloud.Models.RuleSuite"/> and sets the default values.
        /// </summary>
        public RuleSuite()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.EnterpriseCloud.Models.RuleSuite"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::GitHub.EnterpriseCloud.Models.RuleSuite CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHub.EnterpriseCloud.Models.RuleSuite();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "evaluation_result", n => { EvaluationResult = n.GetEnumValue<global::GitHub.EnterpriseCloud.Models.RuleSuite_evaluation_result>(); } },
                ...
                { "result", n => { Result = n.GetEnumValue<global::GitHub.EnterpriseCloud.Models.RuleSuite_result>(); } },
                { "rule_evaluations", n => { RuleEvaluations = n.GetCollectionOfObjectValues<global::GitHub.EnterpriseCloud.Models.RuleSuite_rule_evaluations>(global::GitHub.EnterpriseCloud.Models.RuleSuite_rule_evaluations.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::GitHub.EnterpriseCloud.Models.RuleSuite_evaluation_result>("evaluation_result", EvaluationResult);
            ...
            writer.WriteEnumValue<global::GitHub.EnterpriseCloud.Models.RuleSuite_result>("result", Result);
            writer.WriteCollectionOfObjectValues<global::GitHub.EnterpriseCloud.Models.RuleSuite_rule_evaluations>("rule_evaluations", RuleEvaluations);
