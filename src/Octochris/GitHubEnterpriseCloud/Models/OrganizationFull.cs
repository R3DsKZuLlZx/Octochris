...
namespace GitHub.EnterpriseCloud.Models
{
    ...
    public partial class OrganizationFull : IAdditionalDataHolder, IParsable
    {
        ...
        /// <summary>**Endpoint closing down notice.** Please use [code security configurations](https://docs.github.com/enterprise-cloud@latest/rest/code-security/configurations) instead.Whether GitHub Advanced Security is enabled for new repositories and repositories transferred to this organization.This field is only visible to organization owners or members of a team with the security manager role.</summary>
        [Obsolete("")]
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::GitHub.EnterpriseCloud.Models.OrganizationFull_plan? Plan { get; set; }
#nullable restore
#else
        public global::GitHub.EnterpriseCloud.Models.OrganizationFull_plan Plan { get; set; }
#endif
...
#nullable restore
        ...
        public string ReposUrl { get; set; }
#endif
        /// <summary>**Endpoint closing down notice.** Please use [code security configurations](https://docs.github.com/enterprise-cloud@latest/rest/code-security/configurations) instead.Whether secret scanning is automatically enabled for new repositories and repositories transferred to this organization.This field is only visible to organization owners or members of a team with the security manager role.</summary>
        [Obsolete("")]
...
#nullable restore
        ...
        /// <summary>**Endpoint closing down notice.** Please use [code security configurations](https://docs.github.com/enterprise-cloud@latest/rest/code-security/configurations) instead.Whether secret scanning push protection is automatically enabled for new repositories and repositories transferred to this organization.This field is only visible to organization owners or members of a team with the security manager role.</summary>
        [Obsolete("")]
...
#nullable restore
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.EnterpriseCloud.Models.OrganizationFull"/> and sets the default values.
        /// </summary>
        ...
        public static global::GitHub.EnterpriseCloud.Models.OrganizationFull CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHub.EnterpriseCloud.Models.OrganizationFull();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "plan", n => { Plan = n.GetObjectValue<global::GitHub.EnterpriseCloud.Models.OrganizationFull_plan>(global::GitHub.EnterpriseCloud.Models.OrganizationFull_plan.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::GitHub.EnterpriseCloud.Models.OrganizationFull_plan>("plan", Plan);
