...
using GitHub.EnterpriseCloud.Users.Item.Packages.Item;
...
using System;
namespace GitHub.EnterpriseCloud.Users.Item.Packages
{
    /// <summary>
    ...
    {
        /// <summary>Gets an item from the GitHub.EnterpriseCloud.users.item.packages.item collection</summary>
        ...
        /// <returns>A <see cref="global::GitHub.EnterpriseCloud.Users.Item.Packages.Item.WithPackage_typeItemRequestBuilder"/></returns>
        public global::GitHub.EnterpriseCloud.Users.Item.Packages.Item.WithPackage_typeItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("package_type", position);
                return new global::GitHub.EnterpriseCloud.Users.Item.Packages.Item.WithPackage_typeItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.EnterpriseCloud.Users.Item.Packages.PackagesRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-cloud@latest/rest/packages/packages#list-packages-for-a-user" />
        /// </summary>
        /// <returns>A List&lt;global::GitHub.EnterpriseCloud.Models.Package&gt;</returns>
...
#nullable enable
        public async Task<List<global::GitHub.EnterpriseCloud.Models.Package>?> GetAsync(Action<RequestConfiguration<global::GitHub.EnterpriseCloud.Users.Item.Packages.PackagesRequestBuilder.PackagesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::GitHub.EnterpriseCloud.Models.Package>> GetAsync(Action<RequestConfiguration<global::GitHub.EnterpriseCloud.Users.Item.Packages.PackagesRequestBuilder.PackagesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::GitHub.EnterpriseCloud.Models.Package>(requestInfo, global::GitHub.EnterpriseCloud.Models.Package.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.EnterpriseCloud.Users.Item.Packages.PackagesRequestBuilder.PackagesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.EnterpriseCloud.Users.Item.Packages.PackagesRequestBuilder.PackagesRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.EnterpriseCloud.Users.Item.Packages.PackagesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.EnterpriseCloud.Users.Item.Packages.PackagesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.EnterpriseCloud.Users.Item.Packages.PackagesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Lists all packages in a user&apos;s namespace for which the requesting user has access.OAuth app tokens and personal access tokens (classic) need the `read:packages` scope to use this endpoint. For more information, see &quot;[About permissions for GitHub Packages](https://docs.github.com/enterprise-cloud@latest/packages/learn-github-packages/about-permissions-for-github-packages#permissions-for-repository-scoped-packages).&quot;
        /// </summary>
...
#nullable restore
            ...
            /// <summary>The type of supported package. Packages in GitHub&apos;s Gradle registry have the type `maven`. Docker images pushed to GitHub&apos;s Container registry (`ghcr.io`) have the type `container`. You can use the type `docker` to find images that were pushed to GitHub&apos;s Docker registry (`docker.pkg.github.com`), even if these have now been migrated to the Container registry.</summary>
            [QueryParameter("package_type")]
            public global::GitHub.EnterpriseCloud.Users.Item.Packages.GetPackage_typeQueryParameterType? PackageTypeAsGetPackageTypeQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>The selected visibility of the packages.  This parameter is optional and only filters an existing result set.The `internal` visibility is only supported for GitHub Packages registries that allow for granular permissions. For other ecosystems `internal` is synonymous with `private`.For the list of GitHub Packages registries that support granular permissions, see &quot;[About permissions for GitHub Packages](https://docs.github.com/enterprise-cloud@latest/packages/learn-github-packages/about-permissions-for-github-packages#granular-permissions-for-userorganization-scoped-packages).&quot;</summary>
            [QueryParameter("visibility")]
            public global::GitHub.EnterpriseCloud.Users.Item.Packages.GetVisibilityQueryParameterType? VisibilityAsGetVisibilityQueryParameterType { get; set; }
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class PackagesRequestBuilderGetRequestConfiguration : RequestConfiguration<global::GitHub.EnterpriseCloud.Users.Item.Packages.PackagesRequestBuilder.PackagesRequestBuilderGetQueryParameters>
        {
        }
    }
}
