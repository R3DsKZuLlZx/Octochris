...
using GitHub.EnterpriseCloud.User.Codespaces.Item.Exports.Item;
...
using System;
namespace GitHub.EnterpriseCloud.User.Codespaces.Item.Exports
{
    /// <summary>
    ...
    {
        /// <summary>Gets an item from the GitHub.EnterpriseCloud.user.codespaces.item.exports.item collection</summary>
        /// <param name="position">The ID of the export operation, or `latest`. Currently only `latest` is currently supported.</param>
        /// <returns>A <see cref="global::GitHub.EnterpriseCloud.User.Codespaces.Item.Exports.Item.WithExport_ItemRequestBuilder"/></returns>
        public global::GitHub.EnterpriseCloud.User.Codespaces.Item.Exports.Item.WithExport_ItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("export_id", position);
                return new global::GitHub.EnterpriseCloud.User.Codespaces.Item.Exports.Item.WithExport_ItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.EnterpriseCloud.User.Codespaces.Item.Exports.ExportsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.EnterpriseCloud.Models.CodespaceExportDetails"/></returns>
...
#nullable enable
        public async Task<global::GitHub.EnterpriseCloud.Models.CodespaceExportDetails?> PostAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHub.EnterpriseCloud.Models.CodespaceExportDetails> PostAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::GitHub.EnterpriseCloud.Models.CodespaceExportDetails>(requestInfo, global::GitHub.EnterpriseCloud.Models.CodespaceExportDetails.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Triggers an export of the specified codespace and returns a URL and ID where the status of the export can be monitored.If changes cannot be pushed to the codespace&apos;s repository, they will be pushed to a new or previously-existing fork instead.OAuth app tokens and personal access tokens (classic) need the `codespace` scope to use this endpoint.
        /// </summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.EnterpriseCloud.User.Codespaces.Item.Exports.ExportsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.EnterpriseCloud.User.Codespaces.Item.Exports.ExportsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.EnterpriseCloud.User.Codespaces.Item.Exports.ExportsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
