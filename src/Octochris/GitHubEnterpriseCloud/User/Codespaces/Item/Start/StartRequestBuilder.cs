...
using System;
namespace GitHub.EnterpriseCloud.User.Codespaces.Item.Start
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.EnterpriseCloud.User.Codespaces.Item.Start.StartRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <exception cref="global::GitHub.EnterpriseCloud.Models.BasicError">When receiving a 402 status code</exception>
...
#nullable enable
        public async Task<global::GitHub.EnterpriseCloud.Models.Codespace?> PostAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHub.EnterpriseCloud.Models.Codespace> PostAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var errorMapping = new Dictionary<string, ParsableFactory<IParsable>>
            {
                ...
                { "402", global::GitHub.EnterpriseCloud.Models.BasicError.CreateFromDiscriminatorValue },
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.EnterpriseCloud.User.Codespaces.Item.Start.StartRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.EnterpriseCloud.User.Codespaces.Item.Start.StartRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.EnterpriseCloud.User.Codespaces.Item.Start.StartRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
