...
namespace GitHub.EnterpriseCloud.User.Codespaces.Secrets.Item
{
    ...
    #pragma warning restore CS1591
    {
        ...
        /// <summary>Value for your secret, encrypted with [LibSodium](https://libsodium.gitbook.io/doc/bindings_for_other_languages) using the public key retrieved from the [Get the public key for the authenticated user](https://docs.github.com/enterprise-cloud@latest/rest/codespaces/secrets#get-public-key-for-the-authenticated-user) endpoint.</summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.EnterpriseCloud.User.Codespaces.Secrets.Item.WithSecret_namePutRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::GitHub.EnterpriseCloud.User.Codespaces.Secrets.Item.WithSecret_namePutRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHub.EnterpriseCloud.User.Codespaces.Secrets.Item.WithSecret_namePutRequestBody();
        }
        /// <summary>
