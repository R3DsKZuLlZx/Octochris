...
using GitHub.EnterpriseCloud.Assignments.Item;
...
using System;
namespace GitHub.EnterpriseCloud.Assignments
{
    /// <summary>
    ...
    public partial class AssignmentsRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::GitHub.EnterpriseCloud.Assignments.Item.WithAssignment_ItemRequestBuilder this[int position]
        {
            get
            {
                ...
                return new global::GitHub.EnterpriseCloud.Assignments.Item.WithAssignment_ItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>Gets an item from the GitHub.EnterpriseCloud.assignments.item collection</summary>
        /// <param name="position">The unique identifier of the classroom assignment.</param>
        ...
        public global::GitHub.EnterpriseCloud.Assignments.Item.WithAssignment_ItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.EnterpriseCloud.Assignments.AssignmentsRequestBuilder"/> and sets the default values.
        /// </summary>
