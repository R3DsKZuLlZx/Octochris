...
using GitHub.EnterpriseCloud.Enterprises.Item.AuditLog.StreamKey;
using GitHub.EnterpriseCloud.Enterprises.Item.AuditLog.Streams;
...
using System;
namespace GitHub.EnterpriseCloud.Enterprises.Item.AuditLog
{
    /// <summary>
    ...
    public partial class AuditLogRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::GitHub.EnterpriseCloud.Enterprises.Item.AuditLog.StreamKey.StreamKeyRequestBuilder StreamKey
        {
            get => new global::GitHub.EnterpriseCloud.Enterprises.Item.AuditLog.StreamKey.StreamKeyRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The streams property</summary>
        public global::GitHub.EnterpriseCloud.Enterprises.Item.AuditLog.Streams.StreamsRequestBuilder Streams
        {
            get => new global::GitHub.EnterpriseCloud.Enterprises.Item.AuditLog.Streams.StreamsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.EnterpriseCloud.Enterprises.Item.AuditLog.AuditLogRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<List<global::GitHub.EnterpriseCloud.Models.AuditLogEvent>?> GetAsync(Action<RequestConfiguration<global::GitHub.EnterpriseCloud.Enterprises.Item.AuditLog.AuditLogRequestBuilder.AuditLogRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::GitHub.EnterpriseCloud.Models.AuditLogEvent>> GetAsync(Action<RequestConfiguration<global::GitHub.EnterpriseCloud.Enterprises.Item.AuditLog.AuditLogRequestBuilder.AuditLogRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.EnterpriseCloud.Enterprises.Item.AuditLog.AuditLogRequestBuilder.AuditLogRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.EnterpriseCloud.Enterprises.Item.AuditLog.AuditLogRequestBuilder.AuditLogRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.EnterpriseCloud.Enterprises.Item.AuditLog.AuditLogRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.EnterpriseCloud.Enterprises.Item.AuditLog.AuditLogRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.EnterpriseCloud.Enterprises.Item.AuditLog.AuditLogRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Gets the audit log for an enterprise.This endpoint has a rate limit of 1,750 queries per hour per user and IP address. If your integration receives a rate limit error (typically a 403 or 429 response), it should wait before making another request to the GitHub API. For more information, see &quot;[Rate limits for the REST API](https://docs.github.com/enterprise-cloud@latest/rest/using-the-rest-api/rate-limits-for-the-rest-api)&quot; and &quot;[Best practices for integrators](https://docs.github.com/enterprise-cloud@latest/rest/guides/best-practices-for-integrators).&quot;The authenticated user must be an enterprise admin to use this endpoint.OAuth app tokens and personal access tokens (classic) need the `read:audit_log` scope to use this endpoint.
        /// </summary>
...
#nullable restore
            ...
            /// <summary>The event types to include:- `web` - returns web (non-Git) events.- `git` - returns Git events.- `all` - returns both web and Git events.The default is `web`.</summary>
            [QueryParameter("include")]
            public global::GitHub.EnterpriseCloud.Enterprises.Item.AuditLog.GetIncludeQueryParameterType? IncludeAsGetIncludeQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>The order of audit log events. To list newest events first, specify `desc`. To list oldest events first, specify `asc`.The default is `desc`.</summary>
            [QueryParameter("order")]
            public global::GitHub.EnterpriseCloud.Enterprises.Item.AuditLog.GetOrderQueryParameterType? OrderAsGetOrderQueryParameterType { get; set; }
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class AuditLogRequestBuilderGetRequestConfiguration : RequestConfiguration<global::GitHub.EnterpriseCloud.Enterprises.Item.AuditLog.AuditLogRequestBuilder.AuditLogRequestBuilderGetQueryParameters>
        {
        }
    }
}
