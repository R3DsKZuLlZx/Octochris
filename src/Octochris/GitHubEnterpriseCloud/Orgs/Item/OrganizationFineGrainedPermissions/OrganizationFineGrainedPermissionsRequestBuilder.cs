...
using System;
namespace GitHub.EnterpriseCloud.Orgs.Item.OrganizationFineGrainedPermissions
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.EnterpriseCloud.Orgs.Item.OrganizationFineGrainedPermissions.OrganizationFineGrainedPermissionsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A List&lt;global::GitHub.EnterpriseCloud.Models.OrganizationFineGrainedPermission&gt;</returns>
...
#nullable enable
        public async Task<List<global::GitHub.EnterpriseCloud.Models.OrganizationFineGrainedPermission>?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::GitHub.EnterpriseCloud.Models.OrganizationFineGrainedPermission>> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::GitHub.EnterpriseCloud.Models.OrganizationFineGrainedPermission>(requestInfo, global::GitHub.EnterpriseCloud.Models.OrganizationFineGrainedPermission.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.EnterpriseCloud.Orgs.Item.OrganizationFineGrainedPermissions.OrganizationFineGrainedPermissionsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.EnterpriseCloud.Orgs.Item.OrganizationFineGrainedPermissions.OrganizationFineGrainedPermissionsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.EnterpriseCloud.Orgs.Item.OrganizationFineGrainedPermissions.OrganizationFineGrainedPermissionsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class OrganizationFineGrainedPermissionsRequestBuilderGetRequestConfiguration : RequestConfiguration<DefaultQueryParameters>
        {
        }
    }
}
