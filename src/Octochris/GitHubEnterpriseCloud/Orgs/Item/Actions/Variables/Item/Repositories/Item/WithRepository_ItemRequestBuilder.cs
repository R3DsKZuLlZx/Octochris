...
using System;
namespace GitHub.EnterpriseCloud.Orgs.Item.Actions.Variables.Item.Repositories.Item
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.EnterpriseCloud.Orgs.Item.Actions.Variables.Item.Repositories.Item.WithRepository_ItemRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-cloud@latest/rest/actions/variables#remove-selected-repository-from-an-organization-variable" />
        /// </summary>
...
#nullable restore
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-cloud@latest/rest/actions/variables#add-selected-repository-to-an-organization-variable" />
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.EnterpriseCloud.Orgs.Item.Actions.Variables.Item.Repositories.Item.WithRepository_ItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.EnterpriseCloud.Orgs.Item.Actions.Variables.Item.Repositories.Item.WithRepository_ItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
