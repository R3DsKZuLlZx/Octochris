...
using GitHub.EnterpriseCloud.Orgs.Item.PersonalAccessTokenRequests.Item.Repositories;
...
using System;
namespace GitHub.EnterpriseCloud.Orgs.Item.PersonalAccessTokenRequests.Item
{
    /// <summary>
    ...
    public partial class WithPat_request_ItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::GitHub.EnterpriseCloud.Orgs.Item.PersonalAccessTokenRequests.Item.Repositories.RepositoriesRequestBuilder Repositories
        {
            get => new global::GitHub.EnterpriseCloud.Orgs.Item.PersonalAccessTokenRequests.Item.Repositories.RepositoriesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.EnterpriseCloud.Orgs.Item.PersonalAccessTokenRequests.Item.WithPat_request_ItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task PostAsync(global::GitHub.EnterpriseCloud.Orgs.Item.PersonalAccessTokenRequests.Item.WithPat_request_PostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task PostAsync(global::GitHub.EnterpriseCloud.Orgs.Item.PersonalAccessTokenRequests.Item.WithPat_request_PostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::GitHub.EnterpriseCloud.Orgs.Item.PersonalAccessTokenRequests.Item.WithPat_request_PostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::GitHub.EnterpriseCloud.Orgs.Item.PersonalAccessTokenRequests.Item.WithPat_request_PostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.EnterpriseCloud.Orgs.Item.PersonalAccessTokenRequests.Item.WithPat_request_ItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.EnterpriseCloud.Orgs.Item.PersonalAccessTokenRequests.Item.WithPat_request_ItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
