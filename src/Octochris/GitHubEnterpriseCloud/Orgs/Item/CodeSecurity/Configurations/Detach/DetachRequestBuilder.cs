...
using System;
namespace GitHub.EnterpriseCloud.Orgs.Item.CodeSecurity.Configurations.Detach
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.EnterpriseCloud.Orgs.Item.CodeSecurity.Configurations.Detach.DetachRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-cloud@latest/rest/code-security/configurations#detach-configurations-from-repositories" />
        /// </summary>
...
#nullable enable
        public async Task DeleteAsync(global::GitHub.EnterpriseCloud.Orgs.Item.CodeSecurity.Configurations.Detach.DetachDeleteRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task DeleteAsync(global::GitHub.EnterpriseCloud.Orgs.Item.CodeSecurity.Configurations.Detach.DetachDeleteRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToDeleteRequestInformation(global::GitHub.EnterpriseCloud.Orgs.Item.CodeSecurity.Configurations.Detach.DetachDeleteRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToDeleteRequestInformation(global::GitHub.EnterpriseCloud.Orgs.Item.CodeSecurity.Configurations.Detach.DetachDeleteRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.EnterpriseCloud.Orgs.Item.CodeSecurity.Configurations.Detach.DetachRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.EnterpriseCloud.Orgs.Item.CodeSecurity.Configurations.Detach.DetachRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.EnterpriseCloud.Orgs.Item.CodeSecurity.Configurations.Detach.DetachRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
