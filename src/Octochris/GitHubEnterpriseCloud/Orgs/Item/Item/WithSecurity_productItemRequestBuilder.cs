...
using GitHub.EnterpriseCloud.Orgs.Item.Item.Item;
...
using System;
namespace GitHub.EnterpriseCloud.Orgs.Item.Item
{
    /// <summary>
    ...
    {
        /// <summary>Gets an item from the GitHub.EnterpriseCloud.orgs.item.item.item collection</summary>
        ...
        [Obsolete("")]
        public global::GitHub.EnterpriseCloud.Orgs.Item.Item.Item.WithEnablementItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("enablement", position);
                return new global::GitHub.EnterpriseCloud.Orgs.Item.Item.Item.WithEnablementItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.EnterpriseCloud.Orgs.Item.Item.WithSecurity_productItemRequestBuilder"/> and sets the default values.
        /// </summary>
