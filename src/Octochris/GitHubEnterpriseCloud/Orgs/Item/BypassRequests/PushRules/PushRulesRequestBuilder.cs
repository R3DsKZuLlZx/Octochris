...
using System;
namespace GitHub.EnterpriseCloud.Orgs.Item.BypassRequests.PushRules
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.EnterpriseCloud.Orgs.Item.BypassRequests.PushRules.PushRulesRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<List<global::GitHub.EnterpriseCloud.Models.PushRuleBypassRequest>?> GetAsync(Action<RequestConfiguration<global::GitHub.EnterpriseCloud.Orgs.Item.BypassRequests.PushRules.PushRulesRequestBuilder.PushRulesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::GitHub.EnterpriseCloud.Models.PushRuleBypassRequest>> GetAsync(Action<RequestConfiguration<global::GitHub.EnterpriseCloud.Orgs.Item.BypassRequests.PushRules.PushRulesRequestBuilder.PushRulesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.EnterpriseCloud.Orgs.Item.BypassRequests.PushRules.PushRulesRequestBuilder.PushRulesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.EnterpriseCloud.Orgs.Item.BypassRequests.PushRules.PushRulesRequestBuilder.PushRulesRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.EnterpriseCloud.Orgs.Item.BypassRequests.PushRules.PushRulesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.EnterpriseCloud.Orgs.Item.BypassRequests.PushRules.PushRulesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.EnterpriseCloud.Orgs.Item.BypassRequests.PushRules.PushRulesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Lists the requests made by users of a repository to bypass push protection rules within an organization.
        /// </summary>
...
#nullable restore
            ...
            /// <summary>The status of the bypass request to filter on. When specified, only requests with this status will be returned.</summary>
            [QueryParameter("request_status")]
            public global::GitHub.EnterpriseCloud.Orgs.Item.BypassRequests.PushRules.GetRequest_statusQueryParameterType? RequestStatusAsGetRequestStatusQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>The time period to filter by.For example, `day` will filter for rule suites that occurred in the past 24 hours, and `week` will filter for rule suites that occurred in the past 7 days (168 hours).</summary>
            [QueryParameter("time_period")]
            public global::GitHub.EnterpriseCloud.Orgs.Item.BypassRequests.PushRules.GetTime_periodQueryParameterType? TimePeriodAsGetTimePeriodQueryParameterType { get; set; }
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class PushRulesRequestBuilderGetRequestConfiguration : RequestConfiguration<global::GitHub.EnterpriseCloud.Orgs.Item.BypassRequests.PushRules.PushRulesRequestBuilder.PushRulesRequestBuilderGetQueryParameters>
        {
        }
    }
}
