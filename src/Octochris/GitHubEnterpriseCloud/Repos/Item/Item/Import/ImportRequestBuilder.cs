...
using GitHub.EnterpriseCloud.Repos.Item.Item.Import.Authors;
using GitHub.EnterpriseCloud.Repos.Item.Item.Import.Large_files;
using GitHub.EnterpriseCloud.Repos.Item.Item.Import.Lfs;
...
using System;
namespace GitHub.EnterpriseCloud.Repos.Item.Item.Import
{
    /// <summary>
    ...
    public partial class ImportRequestBuilder : BaseRequestBuilder
    {
        ...
        [Obsolete("")]
        public global::GitHub.EnterpriseCloud.Repos.Item.Item.Import.Authors.AuthorsRequestBuilder Authors
        {
            get => new global::GitHub.EnterpriseCloud.Repos.Item.Item.Import.Authors.AuthorsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The large_files property</summary>
        [Obsolete("")]
        public global::GitHub.EnterpriseCloud.Repos.Item.Item.Import.Large_files.Large_filesRequestBuilder Large_files
        {
            get => new global::GitHub.EnterpriseCloud.Repos.Item.Item.Import.Large_files.Large_filesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The lfs property</summary>
        [Obsolete("")]
        public global::GitHub.EnterpriseCloud.Repos.Item.Item.Import.Lfs.LfsRequestBuilder Lfs
        {
            get => new global::GitHub.EnterpriseCloud.Repos.Item.Item.Import.Lfs.LfsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.EnterpriseCloud.Repos.Item.Item.Import.ImportRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-cloud@latest/rest/migrations/source-imports#cancel-an-import" />
        /// </summary>
...
#nullable restore
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-cloud@latest/rest/migrations/source-imports#get-an-import-status" />
        /// </summary>
        /// <returns>A <see cref="global::GitHub.EnterpriseCloud.Models.Import"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::GitHub.EnterpriseCloud.Models.Import?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHub.EnterpriseCloud.Models.Import> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::GitHub.EnterpriseCloud.Models.Import>(requestInfo, global::GitHub.EnterpriseCloud.Models.Import.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-cloud@latest/rest/migrations/source-imports#update-an-import" />
        /// </summary>
        /// <returns>A <see cref="global::GitHub.EnterpriseCloud.Models.Import"/></returns>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::GitHub.EnterpriseCloud.Models.Import?> PatchAsync(global::GitHub.EnterpriseCloud.Repos.Item.Item.Import.ImportPatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHub.EnterpriseCloud.Models.Import> PatchAsync(global::GitHub.EnterpriseCloud.Repos.Item.Item.Import.ImportPatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-cloud@latest/rest/migrations/source-imports#start-an-import" />
        /// </summary>
        /// <returns>A <see cref="global::GitHub.EnterpriseCloud.Models.Import"/></returns>
        /// <param name="body">The request body</param>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::GitHub.EnterpriseCloud.Models.Import?> PutAsync(global::GitHub.EnterpriseCloud.Repos.Item.Item.Import.ImportPutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHub.EnterpriseCloud.Models.Import> PutAsync(global::GitHub.EnterpriseCloud.Repos.Item.Item.Import.ImportPutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::GitHub.EnterpriseCloud.Repos.Item.Item.Import.ImportPatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::GitHub.EnterpriseCloud.Repos.Item.Item.Import.ImportPatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(global::GitHub.EnterpriseCloud.Repos.Item.Item.Import.ImportPutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(global::GitHub.EnterpriseCloud.Repos.Item.Item.Import.ImportPutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.EnterpriseCloud.Repos.Item.Item.Import.ImportRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        [Obsolete("")]
        public global::GitHub.EnterpriseCloud.Repos.Item.Item.Import.ImportRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.EnterpriseCloud.Repos.Item.Item.Import.ImportRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
