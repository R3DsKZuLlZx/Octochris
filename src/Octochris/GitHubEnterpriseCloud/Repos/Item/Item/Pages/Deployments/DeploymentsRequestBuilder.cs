...
using GitHub.EnterpriseCloud.Repos.Item.Item.Pages.Deployments.Item;
...
using System;
namespace GitHub.EnterpriseCloud.Repos.Item.Item.Pages.Deployments
{
    /// <summary>
    ...
    public partial class DeploymentsRequestBuilder : BaseRequestBuilder
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.EnterpriseCloud.Repos.Item.Item.Pages.Deployments.DeploymentsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-cloud@latest/rest/pages/pages#create-a-github-pages-deployment" />
        /// </summary>
        /// <returns>A <see cref="global::GitHub.EnterpriseCloud.Models.PageDeployment"/></returns>
...
#nullable enable
        public async Task<global::GitHub.EnterpriseCloud.Models.PageDeployment?> PostAsync(global::GitHub.EnterpriseCloud.Repos.Item.Item.Pages.Deployments.DeploymentsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHub.EnterpriseCloud.Models.PageDeployment> PostAsync(global::GitHub.EnterpriseCloud.Repos.Item.Item.Pages.Deployments.DeploymentsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::GitHub.EnterpriseCloud.Models.PageDeployment>(requestInfo, global::GitHub.EnterpriseCloud.Models.PageDeployment.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Create a GitHub Pages deployment for a repository.The authenticated user must have write permission to the repository.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPostRequestInformation(global::GitHub.EnterpriseCloud.Repos.Item.Item.Pages.Deployments.DeploymentsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPostRequestInformation(global::GitHub.EnterpriseCloud.Repos.Item.Item.Pages.Deployments.DeploymentsPostRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.EnterpriseCloud.Repos.Item.Item.Pages.Deployments.DeploymentsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.EnterpriseCloud.Repos.Item.Item.Pages.Deployments.DeploymentsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.EnterpriseCloud.Repos.Item.Item.Pages.Deployments.DeploymentsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
