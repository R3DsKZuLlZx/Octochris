...
using GitHub.EnterpriseCloud.Repos.Item.Item.Rulesets.RuleSuites.Item;
...
using System;
namespace GitHub.EnterpriseCloud.Repos.Item.Item.Rulesets.RuleSuites
{
    /// <summary>
    ...
    {
        /// <summary>Gets an item from the GitHub.EnterpriseCloud.repos.item.item.rulesets.ruleSuites.item collection</summary>
        /// <param name="position">The unique identifier of the rule suite result.To get this ID, you can use [GET /repos/{owner}/{repo}/rulesets/rule-suites](https://docs.github.com/enterprise-cloud@latest/rest/repos/rule-suites#list-repository-rule-suites)for repositories and [GET /orgs/{org}/rulesets/rule-suites](https://docs.github.com/enterprise-cloud@latest/rest/orgs/rule-suites#list-organization-rule-suites)for organizations.</param>
        /// <returns>A <see cref="global::GitHub.EnterpriseCloud.Repos.Item.Item.Rulesets.RuleSuites.Item.WithRule_suite_ItemRequestBuilder"/></returns>
        public global::GitHub.EnterpriseCloud.Repos.Item.Item.Rulesets.RuleSuites.Item.WithRule_suite_ItemRequestBuilder this[int position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("rule_suite_id", position);
                return new global::GitHub.EnterpriseCloud.Repos.Item.Item.Rulesets.RuleSuites.Item.WithRule_suite_ItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>Gets an item from the GitHub.EnterpriseCloud.repos.item.item.rulesets.ruleSuites.item collection</summary>
        /// <param name="position">The unique identifier of the rule suite result.To get this ID, you can use [GET /repos/{owner}/{repo}/rulesets/rule-suites](https://docs.github.com/enterprise-cloud@latest/rest/repos/rule-suites#list-repository-rule-suites)for repositories and [GET /orgs/{org}/rulesets/rule-suites](https://docs.github.com/enterprise-cloud@latest/rest/orgs/rule-suites#list-organization-rule-suites)for organizations.</param>
        ...
        public global::GitHub.EnterpriseCloud.Repos.Item.Item.Rulesets.RuleSuites.Item.WithRule_suite_ItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.EnterpriseCloud.Repos.Item.Item.Rulesets.RuleSuites.RuleSuitesRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-cloud@latest/rest/repos/rule-suites#list-repository-rule-suites" />
        /// </summary>
        /// <returns>A List&lt;global::GitHub.EnterpriseCloud.Models.RuleSuites&gt;</returns>
...
#nullable enable
        public async Task<List<global::GitHub.EnterpriseCloud.Models.RuleSuites>?> GetAsync(Action<RequestConfiguration<global::GitHub.EnterpriseCloud.Repos.Item.Item.Rulesets.RuleSuites.RuleSuitesRequestBuilder.RuleSuitesRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::GitHub.EnterpriseCloud.Models.RuleSuites>> GetAsync(Action<RequestConfiguration<global::GitHub.EnterpriseCloud.Repos.Item.Item.Rulesets.RuleSuites.RuleSuitesRequestBuilder.RuleSuitesRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::GitHub.EnterpriseCloud.Models.RuleSuites>(requestInfo, global::GitHub.EnterpriseCloud.Models.RuleSuites.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.EnterpriseCloud.Repos.Item.Item.Rulesets.RuleSuites.RuleSuitesRequestBuilder.RuleSuitesRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.EnterpriseCloud.Repos.Item.Item.Rulesets.RuleSuites.RuleSuitesRequestBuilder.RuleSuitesRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.EnterpriseCloud.Repos.Item.Item.Rulesets.RuleSuites.RuleSuitesRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.EnterpriseCloud.Repos.Item.Item.Rulesets.RuleSuites.RuleSuitesRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.EnterpriseCloud.Repos.Item.Item.Rulesets.RuleSuites.RuleSuitesRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Lists suites of rule evaluations at the repository level.For more information, see &quot;[Managing rulesets for a repository](https://docs.github.com/enterprise-cloud@latest/repositories/configuring-branches-and-merges-in-your-repository/managing-rulesets/managing-rulesets-for-a-repository#viewing-insights-for-rulesets).&quot;
        /// </summary>
...
#nullable restore
            ...
            [Obsolete("This property is deprecated, use EvaluateStatusAsGetEvaluateStatusQueryParameterType instead")]
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
            ...
            /// <summary>The evaluate status to filter on. When specified, only rule suites resulting from rulesets with the specified evaluate status will be returned.  - `all` - all rule suites will be returned.  - `active` - only rule suites resulting from rulesets in active (non-evaluate) mode will be returned.  - `evaluate` - only rule suites resulting from rulesets in evaluate mode will be returned.</summary>
            [QueryParameter("evaluate_status")]
            public global::GitHub.EnterpriseCloud.Repos.Item.Item.Rulesets.RuleSuites.GetEvaluate_statusQueryParameterType? EvaluateStatusAsGetEvaluateStatusQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>The rule suite results to filter on. When specified, only suites with this result will be returned.</summary>
            [QueryParameter("rule_suite_result")]
            public global::GitHub.EnterpriseCloud.Repos.Item.Item.Rulesets.RuleSuites.GetRule_suite_resultQueryParameterType? RuleSuiteResultAsGetRuleSuiteResultQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>The time period to filter by.For example, `day` will filter for rule suites that occurred in the past 24 hours, and `week` will filter for rule suites that occurred in the past 7 days (168 hours).</summary>
            [QueryParameter("time_period")]
            public global::GitHub.EnterpriseCloud.Repos.Item.Item.Rulesets.RuleSuites.GetTime_periodQueryParameterType? TimePeriodAsGetTimePeriodQueryParameterType { get; set; }
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class RuleSuitesRequestBuilderGetRequestConfiguration : RequestConfiguration<global::GitHub.EnterpriseCloud.Repos.Item.Item.Rulesets.RuleSuites.RuleSuitesRequestBuilder.RuleSuitesRequestBuilderGetQueryParameters>
        {
        }
    }
}
