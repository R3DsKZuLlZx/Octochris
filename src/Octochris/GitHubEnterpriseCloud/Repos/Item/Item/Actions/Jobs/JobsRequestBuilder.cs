...
using GitHub.EnterpriseCloud.Repos.Item.Item.Actions.Jobs.Item;
...
using System;
namespace GitHub.EnterpriseCloud.Repos.Item.Item.Actions.Jobs
{
    /// <summary>
    ...
    public partial class JobsRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::GitHub.EnterpriseCloud.Repos.Item.Item.Actions.Jobs.Item.WithJob_ItemRequestBuilder this[int position]
        {
            get
            {
                ...
                return new global::GitHub.EnterpriseCloud.Repos.Item.Item.Actions.Jobs.Item.WithJob_ItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>Gets an item from the GitHub.EnterpriseCloud.repos.item.item.actions.jobs.item collection</summary>
        /// <param name="position">The unique identifier of the job.</param>
        ...
        public global::GitHub.EnterpriseCloud.Repos.Item.Item.Actions.Jobs.Item.WithJob_ItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.EnterpriseCloud.Repos.Item.Item.Actions.Jobs.JobsRequestBuilder"/> and sets the default values.
        /// </summary>
