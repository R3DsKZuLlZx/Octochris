...
using GitHub.EnterpriseCloud.Repos.Item.Item.Collaborators.Item;
...
using System;
namespace GitHub.EnterpriseCloud.Repos.Item.Item.Collaborators
{
    /// <summary>
    ...
    {
        /// <summary>Gets an item from the GitHub.EnterpriseCloud.repos.item.item.collaborators.item collection</summary>
        /// <param name="position">Unique identifier of the item</param>
        /// <returns>A <see cref="global::GitHub.EnterpriseCloud.Repos.Item.Item.Collaborators.Item.WithUsernameItemRequestBuilder"/></returns>
        public global::GitHub.EnterpriseCloud.Repos.Item.Item.Collaborators.Item.WithUsernameItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("username", position);
                return new global::GitHub.EnterpriseCloud.Repos.Item.Item.Collaborators.Item.WithUsernameItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.EnterpriseCloud.Repos.Item.Item.Collaborators.CollaboratorsRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A List&lt;global::GitHub.EnterpriseCloud.Models.Collaborator&gt;</returns>
...
#nullable enable
        public async Task<List<global::GitHub.EnterpriseCloud.Models.Collaborator>?> GetAsync(Action<RequestConfiguration<global::GitHub.EnterpriseCloud.Repos.Item.Item.Collaborators.CollaboratorsRequestBuilder.CollaboratorsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::GitHub.EnterpriseCloud.Models.Collaborator>> GetAsync(Action<RequestConfiguration<global::GitHub.EnterpriseCloud.Repos.Item.Item.Collaborators.CollaboratorsRequestBuilder.CollaboratorsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::GitHub.EnterpriseCloud.Models.Collaborator>(requestInfo, global::GitHub.EnterpriseCloud.Models.Collaborator.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.EnterpriseCloud.Repos.Item.Item.Collaborators.CollaboratorsRequestBuilder.CollaboratorsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.EnterpriseCloud.Repos.Item.Item.Collaborators.CollaboratorsRequestBuilder.CollaboratorsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.EnterpriseCloud.Repos.Item.Item.Collaborators.CollaboratorsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.EnterpriseCloud.Repos.Item.Item.Collaborators.CollaboratorsRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.EnterpriseCloud.Repos.Item.Item.Collaborators.CollaboratorsRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// For organization-owned repositories, the list of collaborators includes outside collaborators, organization members that are direct collaborators, organization members with access through team memberships, organization members with access through default organization permissions, and organization owners.The `permissions` hash returned in the response contains the base role permissions of the collaborator. The `role_name` is the highest role assigned to the collaborator after considering all sources of grants, including: repo, teams, organization, and enterprise.There is presently not a way to differentiate between an organization level grant and a repository level grant from this endpoint response.Team members will include the members of child teams.The authenticated user must have write, maintain, or admin privileges on the repository to use this endpoint. For organization-owned repositories, the authenticated user needs to be a member of the organization.OAuth app tokens and personal access tokens (classic) need the `read:org` and `repo` scopes to use this endpoint.
        /// </summary>
...
#nullable restore
            ...
            /// <summary>Filter collaborators returned by their affiliation. `outside` means all outside collaborators of an organization-owned repository. `direct` means all collaborators with permissions to an organization-owned repository, regardless of organization membership status. `all` means all collaborators the authenticated user can see.</summary>
            [QueryParameter("affiliation")]
            public global::GitHub.EnterpriseCloud.Repos.Item.Item.Collaborators.GetAffiliationQueryParameterType? AffiliationAsGetAffiliationQueryParameterType { get; set; }
...
#nullable restore
            ...
            /// <summary>Filter collaborators by the permissions they have on the repository. If not specified, all collaborators will be returned.</summary>
            [QueryParameter("permission")]
            public global::GitHub.EnterpriseCloud.Repos.Item.Item.Collaborators.GetPermissionQueryParameterType? PermissionAsGetPermissionQueryParameterType { get; set; }
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class CollaboratorsRequestBuilderGetRequestConfiguration : RequestConfiguration<global::GitHub.EnterpriseCloud.Repos.Item.Item.Collaborators.CollaboratorsRequestBuilder.CollaboratorsRequestBuilderGetQueryParameters>
        {
        }
    }
}
