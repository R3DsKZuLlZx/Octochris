...
using System;
namespace GitHub.EnterpriseCloud.Gists.Item.Star
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.EnterpriseCloud.Gists.Item.Star.StarRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <summary>
        /// Unstar a gist
        /// API method documentation <see href="https://docs.github.com/enterprise-cloud@latest/rest/gists/gists#unstar-a-gist" />
        /// </summary>
...
#nullable restore
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-cloud@latest/rest/gists/gists#check-if-a-gist-is-starred" />
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::GitHub.EnterpriseCloud.Models.BasicError">When receiving a 403 status code</exception>
        /// <exception cref="global::GitHub.EnterpriseCloud.Gists.Item.Star.Star404Error">When receiving a 404 status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public async Task GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "403", global::GitHub.EnterpriseCloud.Models.BasicError.CreateFromDiscriminatorValue },
                { "404", global::GitHub.EnterpriseCloud.Gists.Item.Star.Star404Error.CreateFromDiscriminatorValue },
            };
            await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        ...
        /// API method documentation <see href="https://docs.github.com/enterprise-cloud@latest/rest/gists/gists#star-a-gist" />
        /// </summary>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::GitHub.EnterpriseCloud.Models.BasicError">When receiving a 403 status code</exception>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.EnterpriseCloud.Gists.Item.Star.StarRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.EnterpriseCloud.Gists.Item.Star.StarRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.EnterpriseCloud.Gists.Item.Star.StarRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
