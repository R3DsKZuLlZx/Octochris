...
namespace GitHub.Api.Models
{
    ...
    public partial class Team : IAdditionalDataHolder, IParsable
    {
        ...
        public global::GitHub.Api.Models.Team_access_source? AccessSource { get; set; }
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::GitHub.Api.Models.Team_permissions? Permissions { get; set; }
#nullable restore
#else
        public global::GitHub.Api.Models.Team_permissions Permissions { get; set; }
#endif
...
#nullable restore
        ...
        public global::GitHub.Api.Models.Team_type? Type { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Api.Models.Team"/> and sets the default values.
        /// </summary>
        public Team()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Api.Models.Team"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::GitHub.Api.Models.Team CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHub.Api.Models.Team();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            ...
            {
                { "access_source", n => { AccessSource = n.GetEnumValue<global::GitHub.Api.Models.Team_access_source>(); } },
                ...
                { "permissions", n => { Permissions = n.GetObjectValue<global::GitHub.Api.Models.Team_permissions>(global::GitHub.Api.Models.Team_permissions.CreateFromDiscriminatorValue); } },
                { "privacy", n => { Privacy = n.GetStringValue(); } },
                { "repositories_url", n => { RepositoriesUrl = n.GetStringValue(); } },
                { "slug", n => { Slug = n.GetStringValue(); } },
                { "type", n => { Type = n.GetEnumValue<global::GitHub.Api.Models.Team_type>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::GitHub.Api.Models.Team_access_source>("access_source", AccessSource);
            ...
            writer.WriteObjectValue<global::GitHub.Api.Models.Team_permissions>("permissions", Permissions);
            writer.WriteStringValue("privacy", Privacy);
            writer.WriteStringValue("repositories_url", RepositoriesUrl);
            writer.WriteStringValue("slug", Slug);
            writer.WriteEnumValue<global::GitHub.Api.Models.Team_type>("type", Type);
