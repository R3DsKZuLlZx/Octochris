...
namespace GitHub.Api.Models
{
    ...
    #pragma warning restore CS1591
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Api.Models.CampaignSummary_alert_stats"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::GitHub.Api.Models.CampaignSummary_alert_stats CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHub.Api.Models.CampaignSummary_alert_stats();
        }
        /// <summary>
