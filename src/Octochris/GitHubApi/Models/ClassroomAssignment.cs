...
#nullable enable
        public global::GitHub.Api.Models.Classroom? Classroom { get; set; }
#nullable restore
#else
        public global::GitHub.Api.Models.Classroom Classroom { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::GitHub.Api.Models.SimpleClassroomRepository? StarterCodeRepository { get; set; }
#nullable restore
#else
        public global::GitHub.Api.Models.SimpleClassroomRepository StarterCodeRepository { get; set; }
#endif
...
#nullable restore
        ...
        public global::GitHub.Api.Models.ClassroomAssignment_type? Type { get; set; }
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Api.Models.ClassroomAssignment"/> and sets the default values.
        /// </summary>
        ...
        public static global::GitHub.Api.Models.ClassroomAssignment CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHub.Api.Models.ClassroomAssignment();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "classroom", n => { Classroom = n.GetObjectValue<global::GitHub.Api.Models.Classroom>(global::GitHub.Api.Models.Classroom.CreateFromDiscriminatorValue); } },
                ...
                { "starter_code_repository", n => { StarterCodeRepository = n.GetObjectValue<global::GitHub.Api.Models.SimpleClassroomRepository>(global::GitHub.Api.Models.SimpleClassroomRepository.CreateFromDiscriminatorValue); } },
                { "students_are_repo_admins", n => { StudentsAreRepoAdmins = n.GetBoolValue(); } },
                { "submitted", n => { Submitted = n.GetIntValue(); } },
                { "title", n => { Title = n.GetStringValue(); } },
                { "type", n => { Type = n.GetEnumValue<global::GitHub.Api.Models.ClassroomAssignment_type>(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::GitHub.Api.Models.Classroom>("classroom", Classroom);
            ...
            writer.WriteObjectValue<global::GitHub.Api.Models.SimpleClassroomRepository>("starter_code_repository", StarterCodeRepository);
            writer.WriteBoolValue("students_are_repo_admins", StudentsAreRepoAdmins);
            writer.WriteIntValue("submitted", Submitted);
            writer.WriteStringValue("title", Title);
            writer.WriteEnumValue<global::GitHub.Api.Models.ClassroomAssignment_type>("type", Type);
