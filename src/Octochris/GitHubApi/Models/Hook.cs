...
#nullable enable
        public global::GitHub.Api.Models.WebhookConfig? Config { get; set; }
#nullable restore
#else
        public global::GitHub.Api.Models.WebhookConfig Config { get; set; }
#endif
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public global::GitHub.Api.Models.HookResponse? LastResponse { get; set; }
#nullable restore
#else
        public global::GitHub.Api.Models.HookResponse LastResponse { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Api.Models.Hook"/> and sets the default values.
        /// </summary>
        public Hook()
        {
        ...
        public static global::GitHub.Api.Models.Hook CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHub.Api.Models.Hook();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "config", n => { Config = n.GetObjectValue<global::GitHub.Api.Models.WebhookConfig>(global::GitHub.Api.Models.WebhookConfig.CreateFromDiscriminatorValue); } },
                ...
                { "last_response", n => { LastResponse = n.GetObjectValue<global::GitHub.Api.Models.HookResponse>(global::GitHub.Api.Models.HookResponse.CreateFromDiscriminatorValue); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteObjectValue<global::GitHub.Api.Models.WebhookConfig>("config", Config);
            writer.WriteDateTimeOffsetValue("created_at", CreatedAt);
            writer.WriteStringValue("deliveries_url", DeliveriesUrl);
            writer.WriteCollectionOfPrimitiveValues<string>("events", Events);
            writer.WriteIntValue("id", Id);
            writer.WriteObjectValue<global::GitHub.Api.Models.HookResponse>("last_response", LastResponse);
