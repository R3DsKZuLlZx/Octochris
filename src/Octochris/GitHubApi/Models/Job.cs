...
#nullable restore
        ...
        public global::GitHub.Api.Models.Job_conclusion? Conclusion { get; set; }
...
#nullable restore
        ...
        public global::GitHub.Api.Models.Job_status? Status { get; set; }
        /// <summary>Steps in this job.</summary>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::GitHub.Api.Models.Job_steps>? Steps { get; set; }
#nullable restore
#else
        public List<global::GitHub.Api.Models.Job_steps> Steps { get; set; }
#endif
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Api.Models.Job"/> and sets the default values.
        /// </summary>
        public Job()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Api.Models.Job"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::GitHub.Api.Models.Job CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHub.Api.Models.Job();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "conclusion", n => { Conclusion = n.GetEnumValue<global::GitHub.Api.Models.Job_conclusion>(); } },
                ...
                { "status", n => { Status = n.GetEnumValue<global::GitHub.Api.Models.Job_status>(); } },
                { "steps", n => { Steps = n.GetCollectionOfObjectValues<global::GitHub.Api.Models.Job_steps>(global::GitHub.Api.Models.Job_steps.CreateFromDiscriminatorValue)?.AsList(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::GitHub.Api.Models.Job_conclusion>("conclusion", Conclusion);
            ...
            writer.WriteEnumValue<global::GitHub.Api.Models.Job_status>("status", Status);
            writer.WriteCollectionOfObjectValues<global::GitHub.Api.Models.Job_steps>("steps", Steps);
