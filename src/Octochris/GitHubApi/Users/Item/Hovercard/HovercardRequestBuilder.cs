...
using System;
namespace GitHub.Api.Users.Item.Hovercard
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Api.Users.Item.Hovercard.HovercardRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Api.Models.Hovercard"/></returns>
...
#nullable enable
        public async Task<global::GitHub.Api.Models.Hovercard?> GetAsync(Action<RequestConfiguration<global::GitHub.Api.Users.Item.Hovercard.HovercardRequestBuilder.HovercardRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHub.Api.Models.Hovercard> GetAsync(Action<RequestConfiguration<global::GitHub.Api.Users.Item.Hovercard.HovercardRequestBuilder.HovercardRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::GitHub.Api.Models.Hovercard>(requestInfo, global::GitHub.Api.Models.Hovercard.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Provides hovercard information. You can find out more about someone in relation to their pull requests, issues, repositories, and organizations.  The `subject_type` and `subject_id` parameters provide context for the person&apos;s hovercard, which returns more information than without the parameters. For example, if you wanted to find out more about `octocat` who owns the `Spoon-Knife` repository, you would use a `subject_type` value of `repository` and a `subject_id` value of `1300192` (the ID of the `Spoon-Knife` repository).OAuth app tokens and personal access tokens (classic) need the `repo` scope to use this endpoint.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.Api.Users.Item.Hovercard.HovercardRequestBuilder.HovercardRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.Api.Users.Item.Hovercard.HovercardRequestBuilder.HovercardRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Api.Users.Item.Hovercard.HovercardRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.Api.Users.Item.Hovercard.HovercardRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.Api.Users.Item.Hovercard.HovercardRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Provides hovercard information. You can find out more about someone in relation to their pull requests, issues, repositories, and organizations.  The `subject_type` and `subject_id` parameters provide context for the person&apos;s hovercard, which returns more information than without the parameters. For example, if you wanted to find out more about `octocat` who owns the `Spoon-Knife` repository, you would use a `subject_type` value of `repository` and a `subject_id` value of `1300192` (the ID of the `Spoon-Knife` repository).OAuth app tokens and personal access tokens (classic) need the `repo` scope to use this endpoint.
        /// </summary>
...
#nullable restore
            ...
            /// <summary>Identifies which additional information you&apos;d like to receive about the person&apos;s hovercard. Can be `organization`, `repository`, `issue`, `pull_request`. **Required** when using `subject_id`.</summary>
            [QueryParameter("subject_type")]
            public global::GitHub.Api.Users.Item.Hovercard.GetSubject_typeQueryParameterType? SubjectTypeAsGetSubjectTypeQueryParameterType { get; set; }
        }
        /// <summary>
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class HovercardRequestBuilderGetRequestConfiguration : RequestConfiguration<global::GitHub.Api.Users.Item.Hovercard.HovercardRequestBuilder.HovercardRequestBuilderGetQueryParameters>
        {
        }
    }
}
