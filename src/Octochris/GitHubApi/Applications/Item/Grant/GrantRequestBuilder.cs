...
using System;
namespace GitHub.Api.Applications.Item.Grant
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Api.Applications.Item.Grant.GrantRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task DeleteAsync(global::GitHub.Api.Applications.Item.Grant.GrantDeleteRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task DeleteAsync(global::GitHub.Api.Applications.Item.Grant.GrantDeleteRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToDeleteRequestInformation(global::GitHub.Api.Applications.Item.Grant.GrantDeleteRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToDeleteRequestInformation(global::GitHub.Api.Applications.Item.Grant.GrantDeleteRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Api.Applications.Item.Grant.GrantRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.Api.Applications.Item.Grant.GrantRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.Api.Applications.Item.Grant.GrantRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
