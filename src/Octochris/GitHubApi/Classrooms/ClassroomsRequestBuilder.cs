...
using GitHub.Api.Classrooms.Item;
...
using System;
namespace GitHub.Api.Classrooms
{
    /// <summary>
    ...
    public partial class ClassroomsRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::GitHub.Api.Classrooms.Item.WithClassroom_ItemRequestBuilder this[int position]
        {
            get
            {
                ...
                return new global::GitHub.Api.Classrooms.Item.WithClassroom_ItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>Gets an item from the GitHub.Api.classrooms.item collection</summary>
        /// <param name="position">The unique identifier of the classroom.</param>
        ...
        public global::GitHub.Api.Classrooms.Item.WithClassroom_ItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Api.Classrooms.ClassroomsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        public async Task<List<global::GitHub.Api.Models.SimpleClassroom>> GetAsync(Action<RequestConfiguration<global::GitHub.Api.Classrooms.ClassroomsRequestBuilder.ClassroomsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::GitHub.Api.Models.SimpleClassroom>(requestInfo, global::GitHub.Api.Models.SimpleClassroom.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class ClassroomsRequestBuilderGetRequestConfiguration : RequestConfiguration<global::GitHub.Api.Classrooms.ClassroomsRequestBuilder.ClassroomsRequestBuilderGetQueryParameters>
        {
        }
    }
}
