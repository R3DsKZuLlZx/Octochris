...
using GitHub.Api.Assignments.Item;
...
using System;
namespace GitHub.Api.Assignments
{
    /// <summary>
    ...
    public partial class AssignmentsRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::GitHub.Api.Assignments.Item.WithAssignment_ItemRequestBuilder this[int position]
        {
            get
            {
                ...
                return new global::GitHub.Api.Assignments.Item.WithAssignment_ItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>Gets an item from the GitHub.Api.assignments.item collection</summary>
        /// <param name="position">The unique identifier of the classroom assignment.</param>
        ...
        public global::GitHub.Api.Assignments.Item.WithAssignment_ItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
        ...
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Api.Assignments.AssignmentsRequestBuilder"/> and sets the default values.
        /// </summary>
