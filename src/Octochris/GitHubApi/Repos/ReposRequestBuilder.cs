...
namespace GitHub.Api.Repos
{
    ...
    {
        /// <summary>Gets an item from the GitHub.Api.repos.item collection</summary>
        /// <param name="position">The account owner of the repository. The name is not case sensitive.</param>
        /// <returns>A <see cref="global::GitHub.Api.Repos.Item.OwnerItemRequestBuilder"/></returns>
        public global::GitHub.Api.Repos.Item.OwnerItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("owner%2Did", position);
                return new global::GitHub.Api.Repos.Item.OwnerItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Api.Repos.ReposRequestBuilder"/> and sets the default values.
        /// </summary>
