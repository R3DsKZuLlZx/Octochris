...
using GitHub.Api.Repos.Item.Item.Compare.Item;
...
using System;
namespace GitHub.Api.Repos.Item.Item.Compare
{
    /// <summary>
    ...
    {
        /// <summary>Gets an item from the GitHub.Api.repos.item.item.compare.item collection</summary>
        ...
        public global::GitHub.Api.Repos.Item.Item.Compare.Item.WithBaseheadItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("basehead", position);
                return new global::GitHub.Api.Repos.Item.Item.Compare.Item.WithBaseheadItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Api.Repos.Item.Item.Compare.CompareRequestBuilder"/> and sets the default values.
        /// </summary>
