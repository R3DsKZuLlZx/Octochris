...
using GitHub.Api.Repos.Item.Item.Import.Authors;
using GitHub.Api.Repos.Item.Item.Import.Large_files;
using GitHub.Api.Repos.Item.Item.Import.Lfs;
...
using System;
namespace GitHub.Api.Repos.Item.Item.Import
{
    /// <summary>
    ...
    public partial class ImportRequestBuilder : BaseRequestBuilder
    {
        ...
        [Obsolete("")]
        public global::GitHub.Api.Repos.Item.Item.Import.Authors.AuthorsRequestBuilder Authors
        {
            get => new global::GitHub.Api.Repos.Item.Item.Import.Authors.AuthorsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The large_files property</summary>
        [Obsolete("")]
        public global::GitHub.Api.Repos.Item.Item.Import.Large_files.Large_filesRequestBuilder Large_files
        {
            get => new global::GitHub.Api.Repos.Item.Item.Import.Large_files.Large_filesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The lfs property</summary>
        [Obsolete("")]
        public global::GitHub.Api.Repos.Item.Item.Import.Lfs.LfsRequestBuilder Lfs
        {
            get => new global::GitHub.Api.Repos.Item.Item.Import.Lfs.LfsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Api.Repos.Item.Item.Import.ImportRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// <exception cref="global::GitHub.Api.Models.BasicError">When receiving a 503 status code</exception>
        [Obsolete("")]
...
#nullable restore
        ...
        public async Task DeleteAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "503", global::GitHub.Api.Models.BasicError.CreateFromDiscriminatorValue },
            };
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Api.Models.Import"/></returns>
        /// <param name="cancellationToken">Cancellation token to use when cancelling requests</param>
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::GitHub.Api.Models.Import?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHub.Api.Models.Import> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::GitHub.Api.Models.Import>(requestInfo, global::GitHub.Api.Models.Import.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::GitHub.Api.Models.Import?> PatchAsync(global::GitHub.Api.Repos.Item.Item.Import.ImportPatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHub.Api.Models.Import> PatchAsync(global::GitHub.Api.Repos.Item.Item.Import.ImportPatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::GitHub.Api.Models.Import?> PutAsync(global::GitHub.Api.Repos.Item.Item.Import.ImportPutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHub.Api.Models.Import> PutAsync(global::GitHub.Api.Repos.Item.Item.Import.ImportPutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::GitHub.Api.Repos.Item.Item.Import.ImportPatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::GitHub.Api.Repos.Item.Item.Import.ImportPatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(global::GitHub.Api.Repos.Item.Item.Import.ImportPutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(global::GitHub.Api.Repos.Item.Item.Import.ImportPutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Api.Repos.Item.Item.Import.ImportRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        [Obsolete("")]
        public global::GitHub.Api.Repos.Item.Item.Import.ImportRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.Api.Repos.Item.Item.Import.ImportRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
