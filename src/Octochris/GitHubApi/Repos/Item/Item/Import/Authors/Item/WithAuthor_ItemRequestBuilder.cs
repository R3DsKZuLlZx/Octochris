...
using System;
namespace GitHub.Api.Repos.Item.Item.Import.Authors.Item
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Api.Repos.Item.Item.Import.Authors.Item.WithAuthor_ItemRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Api.Models.PorterAuthor"/></returns>
...
#nullable enable
        public async Task<global::GitHub.Api.Models.PorterAuthor?> PatchAsync(global::GitHub.Api.Repos.Item.Item.Import.Authors.Item.WithAuthor_PatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHub.Api.Models.PorterAuthor> PatchAsync(global::GitHub.Api.Repos.Item.Item.Import.Authors.Item.WithAuthor_PatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::GitHub.Api.Models.PorterAuthor>(requestInfo, global::GitHub.Api.Models.PorterAuthor.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Update an author&apos;s identity for the import. Your application can continue updating authors any time before you pushnew commits to the repository.&gt; [!WARNING]&gt; **Endpoint closing down notice:** Due to very low levels of usage and available alternatives, this endpoint is closing down and will no longer be available from 00:00 UTC on April 12, 2024. For more details and alternatives, see the [changelog](https://gh.io/source-imports-api-deprecation).
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::GitHub.Api.Repos.Item.Item.Import.Authors.Item.WithAuthor_PatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::GitHub.Api.Repos.Item.Item.Import.Authors.Item.WithAuthor_PatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        [Obsolete("")]
        public global::GitHub.Api.Repos.Item.Item.Import.Authors.Item.WithAuthor_ItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.Api.Repos.Item.Item.Import.Authors.Item.WithAuthor_ItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
