...
using GitHub.Api.Repos.Item.Item.Rules.Branches.Item;
...
using System;
namespace GitHub.Api.Repos.Item.Item.Rules.Branches
{
    /// <summary>
    ...
    {
        /// <summary>Gets an item from the GitHub.Api.repos.item.item.rules.branches.item collection</summary>
        ...
        public global::GitHub.Api.Repos.Item.Item.Rules.Branches.Item.WithBranchItemRequestBuilder this[string position]
        {
            get
            {
                var urlTplParams = new Dictionary<string, object>(PathParameters);
                urlTplParams.Add("branch", position);
                return new global::GitHub.Api.Repos.Item.Item.Rules.Branches.Item.WithBranchItemRequestBuilder(urlTplParams, RequestAdapter);
            }
        }
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Api.Repos.Item.Item.Rules.Branches.BranchesRequestBuilder"/> and sets the default values.
        /// </summary>
