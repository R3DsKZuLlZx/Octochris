...
using System;
namespace GitHub.Api.Repos.Item.Item.Commits.Item.BranchesWhereHead
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Api.Repos.Item.Item.Commits.Item.BranchesWhereHead.BranchesWhereHeadRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A List&lt;global::GitHub.Api.Models.BranchShort&gt;</returns>
...
#nullable enable
        public async Task<List<global::GitHub.Api.Models.BranchShort>?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<List<global::GitHub.Api.Models.BranchShort>> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            var collectionResult = await RequestAdapter.SendCollectionAsync<global::GitHub.Api.Models.BranchShort>(requestInfo, global::GitHub.Api.Models.BranchShort.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Api.Repos.Item.Item.Commits.Item.BranchesWhereHead.BranchesWhereHeadRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.Api.Repos.Item.Item.Commits.Item.BranchesWhereHead.BranchesWhereHeadRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.Api.Repos.Item.Item.Commits.Item.BranchesWhereHead.BranchesWhereHeadRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
