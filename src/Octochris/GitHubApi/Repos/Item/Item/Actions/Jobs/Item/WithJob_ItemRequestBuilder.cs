...
using System;
namespace GitHub.Api.Repos.Item.Item.Actions.Jobs.Item
{
    /// <summary>
    ...
    public partial class WithJob_ItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::GitHub.Api.Repos.Item.Item.Actions.Jobs.Item.Logs.LogsRequestBuilder Logs
        {
            get => new global::GitHub.Api.Repos.Item.Item.Actions.Jobs.Item.Logs.LogsRequestBuilder(PathParameters, RequestAdapter);
        }
...
#nullable enable
        public async Task<global::GitHub.Api.Models.Job?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHub.Api.Models.Job> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::GitHub.Api.Models.Job>(requestInfo, global::GitHub.Api.Models.Job.CreateFromDiscriminatorValue, default, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Gets a specific job in a workflow run.Anyone with read access to the repository can use this endpoint.If the repository is private, OAuth tokens and personal access tokens (classic) need the `repo` scope to use this endpoint.
        /// </summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.Api.Repos.Item.Item.Actions.Jobs.Item.WithJob_ItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.Api.Repos.Item.Item.Actions.Jobs.Item.WithJob_ItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
