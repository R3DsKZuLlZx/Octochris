...
using System;
namespace GitHub.Api.Repos.Item.Item.Git.Trees.Item
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Api.Repos.Item.Item.Git.Trees.Item.WithTree_shaItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<global::GitHub.Api.Models.GitTree?> GetAsync(Action<RequestConfiguration<global::GitHub.Api.Repos.Item.Item.Git.Trees.Item.WithTree_shaItemRequestBuilder.WithTree_shaItemRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHub.Api.Models.GitTree> GetAsync(Action<RequestConfiguration<global::GitHub.Api.Repos.Item.Item.Git.Trees.Item.WithTree_shaItemRequestBuilder.WithTree_shaItemRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.Api.Repos.Item.Item.Git.Trees.Item.WithTree_shaItemRequestBuilder.WithTree_shaItemRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::GitHub.Api.Repos.Item.Item.Git.Trees.Item.WithTree_shaItemRequestBuilder.WithTree_shaItemRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.Api.Repos.Item.Item.Git.Trees.Item.WithTree_shaItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.Api.Repos.Item.Item.Git.Trees.Item.WithTree_shaItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
        /// Returns a single tree using the SHA1 value or ref name for that tree.If `truncated` is `true` in the response then the number of items in the `tree` array exceeded our maximum limit. If you need to fetch more items, use the non-recursive method of fetching trees, and fetch one sub-tree at a time.&gt; [!NOTE]&gt; The limit for the `tree` array is 100,000 entries with a maximum size of 7 MB when using the `recursive` parameter.
        /// </summary>
...
#nullable restore
        ...
        [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
        public partial class WithTree_shaItemRequestBuilderGetRequestConfiguration : RequestConfiguration<global::GitHub.Api.Repos.Item.Item.Git.Trees.Item.WithTree_shaItemRequestBuilder.WithTree_shaItemRequestBuilderGetQueryParameters>
        {
        }
    }
}
