...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public List<global::GitHub.Api.Repos.Item.Item.Git.Trees.TreesPostRequestBody_tree>? Tree { get; set; }
#nullable restore
#else
        public List<global::GitHub.Api.Repos.Item.Item.Git.Trees.TreesPostRequestBody_tree> Tree { get; set; }
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Api.Repos.Item.Item.Git.Trees.TreesPostRequestBody"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Api.Repos.Item.Item.Git.Trees.TreesPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::GitHub.Api.Repos.Item.Item.Git.Trees.TreesPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHub.Api.Repos.Item.Item.Git.Trees.TreesPostRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "tree", n => { Tree = n.GetCollectionOfObjectValues<global::GitHub.Api.Repos.Item.Item.Git.Trees.TreesPostRequestBody_tree>(global::GitHub.Api.Repos.Item.Item.Git.Trees.TreesPostRequestBody_tree.CreateFromDiscriminatorValue)?.AsList(); } },
            };
        }
        /// <summary>
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteCollectionOfObjectValues<global::GitHub.Api.Repos.Item.Item.Git.Trees.TreesPostRequestBody_tree>("tree", Tree);
