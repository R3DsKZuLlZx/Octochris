...
using GitHub.Api.Orgs.Item.OrganizationRoles.Item.Teams;
using GitHub.Api.Orgs.Item.OrganizationRoles.Item.Users;
...
using System;
namespace GitHub.Api.Orgs.Item.OrganizationRoles.Item
{
    /// <summary>
    ...
    public partial class WithRole_ItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::GitHub.Api.Orgs.Item.OrganizationRoles.Item.Teams.TeamsRequestBuilder Teams
        {
            get => new global::GitHub.Api.Orgs.Item.OrganizationRoles.Item.Teams.TeamsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The users property</summary>
        public global::GitHub.Api.Orgs.Item.OrganizationRoles.Item.Users.UsersRequestBuilder Users
        {
            get => new global::GitHub.Api.Orgs.Item.OrganizationRoles.Item.Users.UsersRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Api.Orgs.Item.OrganizationRoles.Item.WithRole_ItemRequestBuilder"/> and sets the default values.
        /// </summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Api.Models.OrganizationRole"/></returns>
...
#nullable enable
        public async Task<global::GitHub.Api.Models.OrganizationRole?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHub.Api.Models.OrganizationRole> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            return await RequestAdapter.SendAsync<global::GitHub.Api.Models.OrganizationRole>(requestInfo, global::GitHub.Api.Models.OrganizationRole.CreateFromDiscriminatorValue, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
        /// Gets an organization role that is available to this organization. For more information on organization roles, see &quot;[Using organization roles](https://docs.github.com/organizations/managing-peoples-access-to-your-organization-with-roles/using-organization-roles).&quot;To use this endpoint, the authenticated user must be one of:- An administrator for the organization.- An organization member (or a member of a team) assigned a custom organization role that includes the **View organization roles** (`read_organization_custom_org_role`) permission. For more information, see &quot;[Permissions for organization access](https://docs.github.com/organizations/managing-peoples-access-to-your-organization-with-roles/permissions-of-custom-organization-roles#permissions-for-organization-access).&quot;OAuth app tokens and personal access tokens (classic) need the `admin:org` scope to use this endpoint.
        /// </summary>
...
#nullable restore
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.Api.Orgs.Item.OrganizationRoles.Item.WithRole_ItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.Api.Orgs.Item.OrganizationRoles.Item.WithRole_ItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
