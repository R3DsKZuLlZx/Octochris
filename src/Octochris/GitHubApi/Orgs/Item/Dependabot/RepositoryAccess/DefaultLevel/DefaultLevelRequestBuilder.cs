...
using System;
namespace GitHub.Api.Orgs.Item.Dependabot.RepositoryAccess.DefaultLevel
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Api.Orgs.Item.Dependabot.RepositoryAccess.DefaultLevel.DefaultLevelRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task PutAsync(global::GitHub.Api.Orgs.Item.Dependabot.RepositoryAccess.DefaultLevel.DefaultLevelPutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task PutAsync(global::GitHub.Api.Orgs.Item.Dependabot.RepositoryAccess.DefaultLevel.DefaultLevelPutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(global::GitHub.Api.Orgs.Item.Dependabot.RepositoryAccess.DefaultLevel.DefaultLevelPutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(global::GitHub.Api.Orgs.Item.Dependabot.RepositoryAccess.DefaultLevel.DefaultLevelPutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Api.Orgs.Item.Dependabot.RepositoryAccess.DefaultLevel.DefaultLevelRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.Api.Orgs.Item.Dependabot.RepositoryAccess.DefaultLevel.DefaultLevelRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.Api.Orgs.Item.Dependabot.RepositoryAccess.DefaultLevel.DefaultLevelRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
