...
using GitHub.Api.Orgs.Item.Codespaces.Access.Selected_users;
...
using System;
namespace GitHub.Api.Orgs.Item.Codespaces.Access
{
    /// <summary>
    ...
    public partial class AccessRequestBuilder : BaseRequestBuilder
    {
        ...
        [Obsolete("")]
        public global::GitHub.Api.Orgs.Item.Codespaces.Access.Selected_users.Selected_usersRequestBuilder Selected_users
        {
            get => new global::GitHub.Api.Orgs.Item.Codespaces.Access.Selected_users.Selected_usersRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Api.Orgs.Item.Codespaces.Access.AccessRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task PutAsync(global::GitHub.Api.Orgs.Item.Codespaces.Access.AccessPutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task PutAsync(global::GitHub.Api.Orgs.Item.Codespaces.Access.AccessPutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPutRequestInformation(global::GitHub.Api.Orgs.Item.Codespaces.Access.AccessPutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPutRequestInformation(global::GitHub.Api.Orgs.Item.Codespaces.Access.AccessPutRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Api.Orgs.Item.Codespaces.Access.AccessRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        [Obsolete("")]
        public global::GitHub.Api.Orgs.Item.Codespaces.Access.AccessRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.Api.Orgs.Item.Codespaces.Access.AccessRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
