...
using GitHub.Api.Orgs.Item.Hooks.Item.Config;
using GitHub.Api.Orgs.Item.Hooks.Item.Deliveries;
using GitHub.Api.Orgs.Item.Hooks.Item.Pings;
...
using System;
namespace GitHub.Api.Orgs.Item.Hooks.Item
{
    /// <summary>
    ...
    public partial class WithHook_ItemRequestBuilder : BaseRequestBuilder
    {
        ...
        public global::GitHub.Api.Orgs.Item.Hooks.Item.Config.ConfigRequestBuilder Config
        {
            get => new global::GitHub.Api.Orgs.Item.Hooks.Item.Config.ConfigRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The deliveries property</summary>
        public global::GitHub.Api.Orgs.Item.Hooks.Item.Deliveries.DeliveriesRequestBuilder Deliveries
        {
            get => new global::GitHub.Api.Orgs.Item.Hooks.Item.Deliveries.DeliveriesRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>The pings property</summary>
        public global::GitHub.Api.Orgs.Item.Hooks.Item.Pings.PingsRequestBuilder Pings
        {
            get => new global::GitHub.Api.Orgs.Item.Hooks.Item.Pings.PingsRequestBuilder(PathParameters, RequestAdapter);
        }
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Api.Orgs.Item.Hooks.Item.WithHook_ItemRequestBuilder"/> and sets the default values.
        /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::GitHub.Api.Models.OrgHook?> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHub.Api.Models.OrgHook> GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::GitHub.Api.Models.OrgHook?> PatchAsync(global::GitHub.Api.Orgs.Item.Hooks.Item.WithHook_PatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::GitHub.Api.Models.OrgHook> PatchAsync(global::GitHub.Api.Orgs.Item.Hooks.Item.WithHook_PatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToPatchRequestInformation(global::GitHub.Api.Orgs.Item.Hooks.Item.WithHook_PatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToPatchRequestInformation(global::GitHub.Api.Orgs.Item.Hooks.Item.WithHook_PatchRequestBody body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default)
        ...
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.Api.Orgs.Item.Hooks.Item.WithHook_ItemRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.Api.Orgs.Item.Hooks.Item.WithHook_ItemRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
