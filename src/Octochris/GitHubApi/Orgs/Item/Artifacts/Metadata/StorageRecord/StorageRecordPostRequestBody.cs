...
#nullable restore
        ...
        public global::GitHub.Api.Orgs.Item.Artifacts.Metadata.StorageRecord.StorageRecordPostRequestBody_status? Status { get; set; }
...
#nullable restore
...
#endif
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Api.Orgs.Item.Artifacts.Metadata.StorageRecord.StorageRecordPostRequestBody"/> and sets the default values.
        /// </summary>
        public StorageRecordPostRequestBody()
        {
            AdditionalData = new Dictionary<string, object>();
            ReturnRecords = true;
            Status = global::GitHub.Api.Orgs.Item.Artifacts.Metadata.StorageRecord.StorageRecordPostRequestBody_status.Active;
        }
        /// <summary>
        /// Creates a new instance of the appropriate class based on discriminator value
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Api.Orgs.Item.Artifacts.Metadata.StorageRecord.StorageRecordPostRequestBody"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::GitHub.Api.Orgs.Item.Artifacts.Metadata.StorageRecord.StorageRecordPostRequestBody CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::GitHub.Api.Orgs.Item.Artifacts.Metadata.StorageRecord.StorageRecordPostRequestBody();
        }
        /// <summary>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "status", n => { Status = n.GetEnumValue<global::GitHub.Api.Orgs.Item.Artifacts.Metadata.StorageRecord.StorageRecordPostRequestBody_status>(); } },
        ...
        public virtual void Serialize(ISerializationWriter writer)
        {
            ...
            writer.WriteEnumValue<global::GitHub.Api.Orgs.Item.Artifacts.Metadata.StorageRecord.StorageRecordPostRequestBody_status>("status", Status);
