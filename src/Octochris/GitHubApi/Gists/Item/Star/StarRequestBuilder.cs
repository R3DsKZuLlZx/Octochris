...
using System;
namespace GitHub.Api.Gists.Item.Star
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::GitHub.Api.Gists.Item.Star.StarRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable restore
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        /// <exception cref="global::GitHub.Api.Models.BasicError">When receiving a 403 status code</exception>
        /// <exception cref="global::GitHub.Api.Gists.Item.Star.Star404Error">When receiving a 404 status code</exception>
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
...
#nullable restore
        ...
        public async Task GetAsync(Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
        {
            ...
            {
                { "403", global::GitHub.Api.Models.BasicError.CreateFromDiscriminatorValue },
                { "404", global::GitHub.Api.Gists.Item.Star.Star404Error.CreateFromDiscriminatorValue },
            };
            await RequestAdapter.SendNoContentAsync(requestInfo, errorMapping, cancellationToken).ConfigureAwait(false);
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::GitHub.Api.Gists.Item.Star.StarRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::GitHub.Api.Gists.Item.Star.StarRequestBuilder WithUrl(string rawUrl)
        {
            return new global::GitHub.Api.Gists.Item.Star.StarRequestBuilder(rawUrl, RequestAdapter);
        }
        /// <summary>
